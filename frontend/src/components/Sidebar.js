        ...
        {isCollapsed ? (
          <div className="collapsed-icons">
            <div className="collapsed-section">
              <Send className="collapsed-icon" size={20} title="Generate" onClick={handleSubmit} />
              <Trash2 className="collapsed-icon" size={20} title="Clear" onClick={handleClear} />
            </div>
            <div className="collapsed-divider" />
            <div className="collapsed-section">
              <MessageCircle className="collapsed-icon" size={20} title="Explain" onClick={explainConfusion} />
              <RotateCcw className="collapsed-icon" size={20} title="Reset" onClick={resetGraph} />
            </div>
          </div>
        ) : (
          <>
            <div className="sidebar-section">
              ...
              {mode === "query" && (
                <div className="input-container" data-testid="query-input-container">
                  <textarea
                  ...
                  <div className="button-group">
                    <button
                      ...
                      data-testid="generate-graph-btn"
                    >
                      <Send size={16} />
                      Generate Graph
                    </button>
